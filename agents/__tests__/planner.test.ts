...
/** Returns the `create` mock from the Groq instance created when planner.ts loads */
...
describe('agents/planner — module initialization branch', () => {
